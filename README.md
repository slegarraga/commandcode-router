...
[![npm](https://img.shields.io/npm/v/commandcode-router.svg)](https://www.npmjs.com/package/commandcode-router)
...
```sh
npx --yes commandcode-router install
```
...
To install a specific git revision instead of the published package:
