...
7. Push the tag and create GitHub release notes. The Release workflow publishes to npm with provenance from the protected `release` environment via OIDC. Do not put an npm token in repository secrets.
